...
function sunset_register_nav_menu(){
	...
	register_nav_menu('priamry','Header Navigation Menu');
}
...
function sunset_share_this( $content ){
	...
	if( is_single() ){
		...
		$content .= '<div class="sunset-shareThis"><h4>Share This Article</h4>';
