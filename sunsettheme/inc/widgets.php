...
class Sunset_Profile_Widget extends WP_Widget {
    ...
    public function form( $instance ){
        echo '<p><strong>No options for this Widget!</strong><br/>You can control the fields of this Widget from <a href="./admin.php?page=pijush_sunset">This Page</a></p>';
    }
		...
		if( $posts_query->have_posts() ):
			...
			//echo '<ul>';
				...
				while( $posts_query->have_posts() ): $posts_query->the_post();
                   ...
                   echo '<div class="row"><div class="col-md-12">'. sunset_posted_footer( true ) .'</div></div>';
