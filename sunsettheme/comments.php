...
<div id="comments" class="comments-area">
	...
	<?php 
		...
		$args = array(
			...
			'comment_field' =>
				'<div class="form-group"><label for="comment">' . _x( 'Comment', 'noun' ) . '</label> <span class="required">*</span><textarea id="comment" class="form-control" name="comment" rows="8" required="required"></textarea></p>',
